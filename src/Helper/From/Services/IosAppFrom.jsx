  ...
  return (
    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
      ...
      <h3 className="text-xl font-semibold text-gray-800 mb-3">
        Start Your <strong>IOS App Development</strong> Journey
      </h3>
      <p className="text-gray-600 mb-6">
        Complete the form below to help us understand your app development requirements. This will enable us to provide a tailored solution that meets your specific needs.
      </p>
